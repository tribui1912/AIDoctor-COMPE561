...
return (
  <div className="flex flex-col items-center min-h-screen bg-gray-50 py-8 px-4">
    {/* Header Section */}
    <div className="mb-12 w-full max-w-6xl text-left">
      <h1 className="text-4xl font-bold mb-4">Patients & Visitors</h1>
      <p className="text-lg text-gray-600">Information for patients and visitors to make your hospital experience as comfortable as possible.</p>
    </div>
    ...
    <div className="w-full max-w-6xl mb-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <span className="text-sm text-gray-600">Get immediate assistance</span>
        </Button>
        <Button 
          variant="outline"
          className="p-6 h-auto flex flex-col items-center gap-2"
        ...
        >
          ...
          <span className="text-sm text-gray-600">Schedule your visit</span>
        </Button>
      </div>
    </div>
    ...
    <div className="w-full max-w-6xl space-y-12">
      {/* FAQ Section */}
      <section id="faq-section" className="bg-white shadow-lg rounded-xl p-6">
      ...
      {/* Chat Section */}
      <section id="chat-section" className="bg-white shadow-lg rounded-xl p-6">
      ...
      {/* Appointment Section */}
      <section id="appointment-section" className="bg-white shadow-lg rounded-xl p-6">
  <h2 className="text-2xl font-semibold mb-6">Book Appointment</h2>
  <div className="space-y-6"> {/* Ensures equal spacing between all blocks */}
    {/* Name Field */}
    <div>
